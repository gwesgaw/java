...
public class 변수 {
	...
	public static void main(String[] args) {
		...
		num = 456; // = 대입연산자 앞에 있는 변수에 뒤에있은 값을 저장(덮어쓰기)
		System.out.println(num);
		
		int num1 = 78, num2 = 45, num3 = 89;  //같은 자료형에서 가능
		...
		//float / iong 자료형은 접미사를 반드시 붙여야 인식됨.
		//float(f F)   iong(l L)
		float f = 1.2f;
		long l = 1L;
		
		num2 = 010;  //8짐수로 인식 (0~7까지 8=>10)
		num3 = 0x10; // 16진수 인식 (0~15(ABCDEF)까지 16=>10)
		
		// + - * / %(나머지)
		
		//국어점수(kor), 영어점구(eng), 수학점수(math) 변수를 선언하고,
